...
with tf.Session() as sess:
  ...
  model.fit(np.array(tupleArray), flowy_labels, epochs=20, verbose=0)
  ...
  for i in range(0,len(predictions)-1):    
    print(sorted_labels_arr[np.argmax(predictions[i])])
...
#  all_trials_total_correct += correct
  f.write("Percentage correct: ")
  percentCorrect = 100.0*correct/adjusted_total
  f.write(str(percentCorrect))
  f.write("\n")
  ...
  f.write("Adjusted Total: ")
  f.write(str(adjusted_total))
#  f.write(total, "Total")
#
